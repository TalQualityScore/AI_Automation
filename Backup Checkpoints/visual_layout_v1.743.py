# --- File: visual_layout_v1.743.py (LAUNCHER) ---
# FIX: Correctly modifies the system path to find the 'src' modules.
...
# We add the 'app' directory to the path, so Python can find the 'src' package within it.
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
APP_DIR = os.path.join(SCRIPT_DIR, "app")
sys.path.insert(0, APP_DIR)

# Now, we can import from 'src' as a proper package
from src.app_logic import VisualLayoutTool
